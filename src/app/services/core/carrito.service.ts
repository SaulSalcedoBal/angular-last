...
const endPoint: string = 'http://apinode.midominio.com/v1/carrito/';
const endPoint2: string = 'http://apinetcore.midominio.com/api/product/wishlist/';
const endPoint3: string = 'http://apinetcore.midominio.com/api/order/cart';
